...
export class CreateUserDto {
  ...
  @MinLength(3, { message: 'Thie name Must be Required'  }) // 'Name must be at least 3 characters'
  @MaxLength(30, { message:'name is not valid'} )  // 'Name must be at most 30 characters'
  name: string;
  // Email
